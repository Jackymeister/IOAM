...
parser.add_argument('--use_SEQL', default=True, help='use SEQL loss')
parser.add_argument('--lambda_low', type=float, default=10, help='occurrence count threshold for SEQL')
